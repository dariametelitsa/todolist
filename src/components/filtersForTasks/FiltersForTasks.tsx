...
export const FiltersForTasks = ({filter, filterCheck}: FiltersForTasksProps) => {
    return (
        <Box sx={filterButtonsContainerSx}>
            <ButtonMemo color={'secondary'}
                        variant={filter === 'all' ? "contained" : 'outlined'}
                        onClick={filterCheck('all')}>All</ButtonMemo>
            <ButtonMemo color='primary'
                        variant={filter === 'active' ? "contained" : 'outlined'}
                        onClick={filterCheck('active')}>Active</ButtonMemo>
            <ButtonMemo color='success'
                        variant={filter === 'completed' ? "contained" : 'outlined'}
                        onClick={filterCheck('completed')}>completed</ButtonMemo>
        </Box>
    );
};